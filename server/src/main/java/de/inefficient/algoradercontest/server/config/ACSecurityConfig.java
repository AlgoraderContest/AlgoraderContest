...
import de.inefficient.algoradercontest.server.config.management.ACSecurityAccessDeniedHandler;
import de.inefficient.algoradercontest.server.config.management.ACSecurityAuthenticationSuccessHandler;
